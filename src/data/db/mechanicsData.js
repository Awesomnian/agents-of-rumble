...
const mechanicsData = [
  ...
  },
  {
    ...
    detailedDescription: "Burn is a damage-over-time effect that not only deals damage but also reduces the effectiveness of healing on the affected unit. This makes it particularly effective against units that rely on healing to sustain themselves in battle.",
    mechanics: [
  ...
  },
  {
    ...
    detailedDescription: "Frost effects reduce both movement and attack speed of affected units, significantly hampering their combat effectiveness. Slowed units are easier to kite and take longer to deal their damage, making frost effects particularly useful for controlling the battlefield.",
    mechanics: [
  ...
  },
  {
    ...
    detailedDescription: "Stun is one of the most powerful control effects in the game, completely preventing affected units from taking any actions. Stunned units cannot move, attack, or use abilities, making them extremely vulnerable. Strategic use of stuns can completely shut down key enemy units.",
    mechanics: [
  ...
  },
  {
    ...
    detailedDescription: "Knockback effects forcibly move enemy units away from the source, disrupting their positioning and potentially pushing them into disadvantageous positions. Knockback can also interrupt certain abilities and attacks, making it a versatile control tool.",
    mechanics: [
